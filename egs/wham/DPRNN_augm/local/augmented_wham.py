...
class AugmentedWhamDataset(Dataset):
    ...
    def __init__(self, wsj_train_dir, task, noise_dir=None, json_dir=None, orig_percentage=0.3, sample_rate=8000,
                 segment=4.0, nondefault_nsrc=None, absolute_db_range=(-40, 0), max_rel_db_sources=10,
                 max_rel_db_noise=15, speed_perturb=(0.95, 1.05)):
