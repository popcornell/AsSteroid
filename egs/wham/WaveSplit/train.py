...
class Wavesplit(pl.LightningModule): # redefinition
    ...
    def __init__(self, train_loader,
        ...
        self.sep_stack = SeparationStack(512, 8, 3, mask_act="sigmoid")

        self.spk_loss = SpeakerVectorLoss(101, 512, True, "global")
...
def main(conf):
    ...
    system = Wavesplit(train_loader, val_loader, scheduler, conf)
    # Define callbacks
